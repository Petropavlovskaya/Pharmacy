...
<ul id="menu-v">
    ...
    <li><span><br>Лекарственные средства<br><br></span>
        <ul>
            <li><a href="${pageContext.request.contextPath}/customer/medicine/list"><br>Список лекарственных средств<br><br></a>
            </li>
    ...
    <li><span><br>Личный кабинет<br><br></span>
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/customer/cabinet/history"><br>История заказов<br><br></a>
            </li>
