...
<html>
<head>
    <title>On-line pharmacy. Recipe history</title>
    <style>
...
<div class="div-left">
    <br>
    <br>
    <p class="p-big-left"><fmt:message key="label.404.pageConstruction1"/> <br><fmt:message key="label.404.pageConstruction2"/></p>
    <br>
    <br>
    <c:choose>
